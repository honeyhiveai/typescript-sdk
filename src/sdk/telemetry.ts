...
//   /**
//    * Call this method when you're done with telemetry and want to ensure all events are flushed
//    * This should typically only be called when your application is shutting down
//    */
