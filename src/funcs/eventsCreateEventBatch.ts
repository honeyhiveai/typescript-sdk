 ...
 */
export async function eventsCreateEventBatch(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.CreateEventBatchRequestBody$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/events/batch")();
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.CreateEventBatchResponseBody$inboundSchema),
        m$.jsonErr(500, errors.CreateEventBatchResponseBody$inboundSchema),
        m$.fail(["4XX", "5XX"])
