 ...
 */
export function datasetsAddDatapoints(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.AddDatapointsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/datasets/{dataset_id}/datapoints")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AddDatapointsResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
  if (!result.ok) {
