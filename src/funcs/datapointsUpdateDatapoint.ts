 ...
 */
export async function datapointsUpdateDatapoint(
    ...
    >
> {
    const input$: operations.UpdateDatapointRequest = {
        id: id,
    ...
    const body$ = encodeJSON$("body", payload$.UpdateDatapointRequest, { explode: true });
