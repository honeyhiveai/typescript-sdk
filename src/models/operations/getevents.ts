...
/** @internal */
export const DateRange$inboundSchema: z.ZodType<DateRange, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const DateRange$outboundSchema: z.ZodType<DateRange$Outbound, z.ZodTypeDef, DateRange> = z
    .object({
