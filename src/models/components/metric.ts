...
/** @internal */
export const ReturnTypeT$inboundSchema: z.ZodNativeEnum<typeof ReturnTypeT> =
    z.nativeEnum(ReturnTypeT);
...
/** @internal */
export const Threshold$inboundSchema: z.ZodType<Threshold, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Threshold$outboundSchema: z.ZodType<Threshold$Outbound, z.ZodTypeDef, Threshold> =
    z.object({
        min: z.number().optional(),
        max: z.number().optional(),
    });
