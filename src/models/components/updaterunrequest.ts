...
/** @internal */
export const UpdateRunRequestStatus$inboundSchema: z.ZodNativeEnum<
  typeof UpdateRunRequestStatus
> = z.nativeEnum(UpdateRunRequestStatus);

/** @internal */
export const UpdateRunRequestStatus$outboundSchema: z.ZodNativeEnum<
  typeof UpdateRunRequestStatus
