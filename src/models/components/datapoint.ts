...
/** @internal */
export const Datapoint$inboundSchema: z.ZodType<Datapoint, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const Datapoint$outboundSchema: z.ZodType<Datapoint$Outbound, z.ZodTypeDef, Datapoint> = z
    .object({
