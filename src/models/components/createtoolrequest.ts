...
/** @internal */
export const CreateToolRequestType$inboundSchema: z.ZodNativeEnum<typeof CreateToolRequestType> =
    z.nativeEnum(CreateToolRequestType);

/** @internal */
export const CreateToolRequestType$outboundSchema: z.ZodNativeEnum<typeof CreateToolRequestType> =
...
/** @internal */
export const CreateToolRequest$inboundSchema: z.ZodType<CreateToolRequest, z.ZodTypeDef, unknown> =
    z.object({
        task: z.string(),
        name: z.string(),
