...
/** @internal */
export const EvaluationRunStatus$inboundSchema: z.ZodNativeEnum<
  typeof EvaluationRunStatus
> = z.nativeEnum(EvaluationRunStatus);

/** @internal */
export const EvaluationRunStatus$outboundSchema: z.ZodNativeEnum<
  typeof EvaluationRunStatus
...
/** @internal */
export const EvaluationRun$inboundSchema: z.ZodType<
  EvaluationRun,
  z.ZodTypeDef,
  unknown
> = z.object({
