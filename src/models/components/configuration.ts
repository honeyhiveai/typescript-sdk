...
/** @internal */
export const Env$outboundSchema: z.ZodNativeEnum<typeof Env> = Env$inboundSchema;
...
/** @internal */
export const CallType$inboundSchema: z.ZodNativeEnum<typeof CallType> = z.nativeEnum(CallType);

/** @internal */
export const CallType$outboundSchema: z.ZodNativeEnum<typeof CallType> = CallType$inboundSchema;
...
/** @internal */
export const SelectedFunctions$inboundSchema: z.ZodType<SelectedFunctions, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const FunctionCallParams$inboundSchema: z.ZodNativeEnum<typeof FunctionCallParams> =
    z.nativeEnum(FunctionCallParams);

/** @internal */
export const FunctionCallParams$outboundSchema: z.ZodNativeEnum<typeof FunctionCallParams> =
...
/** @internal */
export const ParametersT$inboundSchema: z.ZodType<ParametersT, z.ZodTypeDef, unknown> =
    collectExtraKeys$(
        z
            .object({
                ...
                selectedFunctions: z
                    .array(z.lazy(() => SelectedFunctions$inboundSchema))
                    .optional(),
...
> = z
    .object({
        ...
        selectedFunctions: z.array(z.lazy(() => SelectedFunctions$outboundSchema)).optional(),
...
/** @internal */
export const ConfigurationType$inboundSchema: z.ZodNativeEnum<typeof ConfigurationType> =
    z.nativeEnum(ConfigurationType);

/** @internal */
export const ConfigurationType$outboundSchema: z.ZodNativeEnum<typeof ConfigurationType> =
...
/** @internal */
export const Configuration$inboundSchema: z.ZodType<Configuration, z.ZodTypeDef, unknown> = z
    .object({
