 ...
 * Type of API calling - "chat" or "completion"
 */
export type PostConfigurationRequestCallType = ClosedEnum<typeof PostConfigurationRequestCallType>;
...
export type PostConfigurationRequestParameters = {
     ...
     */
    selectedFunctions?: Array<PostConfigurationRequestSelectedFunctions> | undefined;
    /**
     * Function calling mode - "none", "auto" or "force"
     */
...
export type PostConfigurationRequestEnv = ClosedEnum<typeof PostConfigurationRequestEnv>;
...
export namespace PostConfigurationRequestResponseFormat$ {
    ...
    export const inboundSchema = PostConfigurationRequestResponseFormat$inboundSchema;
    /** @deprecated use `PostConfigurationRequestResponseFormat$outboundSchema` instead. */
    export const outboundSchema = PostConfigurationRequestResponseFormat$outboundSchema;
...
/** @internal */
export const PostConfigurationRequestSelectedFunctions$outboundSchema: z.ZodType<
...
export namespace PostConfigurationRequestSelectedFunctions$ {
    ...
    export const inboundSchema = PostConfigurationRequestSelectedFunctions$inboundSchema;
    /** @deprecated use `PostConfigurationRequestSelectedFunctions$outboundSchema` instead. */
    export const outboundSchema = PostConfigurationRequestSelectedFunctions$outboundSchema;
...
/** @internal */
export const PostConfigurationRequestFunctionCallParams$inboundSchema: z.ZodNativeEnum<
    typeof PostConfigurationRequestFunctionCallParams
> = z.nativeEnum(PostConfigurationRequestFunctionCallParams);

/** @internal */
export const PostConfigurationRequestFunctionCallParams$outboundSchema: z.ZodNativeEnum<
    typeof PostConfigurationRequestFunctionCallParams
...
export namespace PostConfigurationRequestFunctionCallParams$ {
    ...
    export const inboundSchema = PostConfigurationRequestFunctionCallParams$inboundSchema;
    /** @deprecated use `PostConfigurationRequestFunctionCallParams$outboundSchema` instead. */
    export const outboundSchema = PostConfigurationRequestFunctionCallParams$outboundSchema;
}
...
> = collectExtraKeys$(
    z
        .object({
            ...
            responseFormat: z
                .lazy(() => PostConfigurationRequestResponseFormat$inboundSchema)
                .optional(),
            selectedFunctions: z
                .array(z.lazy(() => PostConfigurationRequestSelectedFunctions$inboundSchema))
                .optional(),
            functionCallParams: PostConfigurationRequestFunctionCallParams$inboundSchema.optional(),
...
export type PostConfigurationRequestParameters$Outbound = {
    ...
    selectedFunctions?: Array<PostConfigurationRequestSelectedFunctions$Outbound> | undefined;
...
> = z
    .object({
        ...
        hyperparameters: z.record(z.any()).optional(),
        responseFormat: z
            .lazy(() => PostConfigurationRequestResponseFormat$outboundSchema)
            .optional(),
        selectedFunctions: z
            .array(z.lazy(() => PostConfigurationRequestSelectedFunctions$outboundSchema))
            .optional(),
        functionCallParams: PostConfigurationRequestFunctionCallParams$outboundSchema.optional(),
        forceFunction: z.record(z.any()).optional(),
...
export namespace PostConfigurationRequestParameters$ {
    ...
    export const outboundSchema = PostConfigurationRequestParameters$outboundSchema;
