 ...
 * Type of API calling - "chat" or "completion"
 */
export type PutConfigurationRequestCallType = ClosedEnum<typeof PutConfigurationRequestCallType>;
...
export type PutConfigurationRequestParameters = {
     ...
     */
    selectedFunctions?: Array<PutConfigurationRequestSelectedFunctions> | undefined;
    /**
     * Function calling mode - "none", "auto" or "force"
     */
...
export type PutConfigurationRequestEnv = ClosedEnum<typeof PutConfigurationRequestEnv>;
 ...
 * Type of the configuration - "LLM" or "pipeline" - "LLM" by default
 */
export type PutConfigurationRequestType = ClosedEnum<typeof PutConfigurationRequestType>;
...
export namespace PutConfigurationRequestResponseFormat$ {
    ...
    export const inboundSchema = PutConfigurationRequestResponseFormat$inboundSchema;
    /** @deprecated use `PutConfigurationRequestResponseFormat$outboundSchema` instead. */
    export const outboundSchema = PutConfigurationRequestResponseFormat$outboundSchema;
...
export namespace PutConfigurationRequestSelectedFunctions$ {
    ...
    export const inboundSchema = PutConfigurationRequestSelectedFunctions$inboundSchema;
    /** @deprecated use `PutConfigurationRequestSelectedFunctions$outboundSchema` instead. */
    export const outboundSchema = PutConfigurationRequestSelectedFunctions$outboundSchema;
...
/** @internal */
export const PutConfigurationRequestFunctionCallParams$inboundSchema: z.ZodNativeEnum<
    typeof PutConfigurationRequestFunctionCallParams
> = z.nativeEnum(PutConfigurationRequestFunctionCallParams);

/** @internal */
export const PutConfigurationRequestFunctionCallParams$outboundSchema: z.ZodNativeEnum<
    typeof PutConfigurationRequestFunctionCallParams
...
export namespace PutConfigurationRequestFunctionCallParams$ {
    ...
    export const inboundSchema = PutConfigurationRequestFunctionCallParams$inboundSchema;
    /** @deprecated use `PutConfigurationRequestFunctionCallParams$outboundSchema` instead. */
    export const outboundSchema = PutConfigurationRequestFunctionCallParams$outboundSchema;
}
...
> = collectExtraKeys$(
    z
        .object({
            ...
            responseFormat: z
                .lazy(() => PutConfigurationRequestResponseFormat$inboundSchema)
                .optional(),
            selectedFunctions: z
                .array(z.lazy(() => PutConfigurationRequestSelectedFunctions$inboundSchema))
                .optional(),
            functionCallParams: PutConfigurationRequestFunctionCallParams$inboundSchema.optional(),
...
export type PutConfigurationRequestParameters$Outbound = {
    ...
    selectedFunctions?: Array<PutConfigurationRequestSelectedFunctions$Outbound> | undefined;
...
> = z
    .object({
        ...
        hyperparameters: z.record(z.any()).optional(),
        responseFormat: z
            .lazy(() => PutConfigurationRequestResponseFormat$outboundSchema)
            .optional(),
        selectedFunctions: z
            .array(z.lazy(() => PutConfigurationRequestSelectedFunctions$outboundSchema))
            .optional(),
        functionCallParams: PutConfigurationRequestFunctionCallParams$outboundSchema.optional(),
        forceFunction: z.record(z.any()).optional(),
...
export namespace PutConfigurationRequestParameters$ {
    ...
    export const outboundSchema = PutConfigurationRequestParameters$outboundSchema;
