 ...
 * What the dataset is to be used for - "evaluation" (default) or "fine-tuning"
 */
export type CreateDatasetRequestType = ClosedEnum<typeof CreateDatasetRequestType>;
 ...
 * The type of data included in the dataset - "event" (default) or "session"
 */
export type CreateDatasetRequestPipelineType = ClosedEnum<typeof CreateDatasetRequestPipelineType>;
